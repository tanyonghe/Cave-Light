/// @function get_reflected_vector(cx, cy, incidence_direction, collision_object)
...
// Find surface normal
n = collision_normal(cx, cy, obj, 16, 4); // http://www.gmlscripts.com/script/collision_normal
nx = lengthdir_x(1, n);
ny = lengthdir_y(1, n);
